...
const fillClasses = {
  slate: "fill-sys-on-secondary",
  blue: "fill-sys-secondary",
  red: "fill-sys-error",
  green: "fill-sys-success",
  white: "fill-sys-on-surface",
} as FillProps;

const strokeClasses = {
  slate: "stroke-sys-on-secondary",
  blue: "stroke-sys-secondary",
  red: "stroke-sys-error",
